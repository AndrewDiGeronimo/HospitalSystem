...
<body>
  <h2> Edit Hospital Confirmation</h2>
...
if ($HospitalID == ''|| $Hospital_Name == ''|| $Hospital_Address == ''|| $Hospital_City == '') {
    ...
    mysqli_query( $conn,"UPDATE Hospital SET Hospital_Name = '$Hospital_Name', Hospital_Address = '$Hospital_Address', Hospital_City = '$Hospital_City' WHERE HospitalID = '$HospitalID' ") or die("Could not execute query: " .mysqli_error($conn));
}
