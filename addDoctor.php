...
if ($LicenseID == '' || $HospitalID == ''|| $Specialty == ''|| $User_Type == ''|| $Password == '') {
    ...
    mysqli_query( $conn,"INSERT INTO Doctor (LicenseID, HospitalID, Doctor_Name, Specialty, User_Type, Password) 
                        VALUES ('$LicenseID', '$HospitalID', '$Doctor_Name', '$Specialty', '$User_Type', '$Password')") or die("Could not execute query: " .mysqli_error($conn));
}
