...
if ($Patient_Name == '' || $Patient_Address == ''|| $Username == '' || $Password == '') {
    ...
    mysqli_query( $conn,"INSERT INTO Patient (Patient_Name, Patient_Address, Username, Password) 
                        VALUES ('$Patient_Name', '$Patient_Address', '$Username','$Password')") or die("Could not execute query: " .mysqli_error($conn));
}
...
?>
<input id="button" type="submit" value="   Go to Login   " />
</form>
</body>
<footer>
